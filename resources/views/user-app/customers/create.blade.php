...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <!-- Form -->
    <form action="{{ route('user.customers.store') }}" method="POST" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="country" id="country"
                        ...
                        <option value="MYS" {{ old('country', 'MY') == 'MYS' ? 'selected' : '' }}>Malaysia</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="document_type" id="document_type"
                        ...
                        <option value="BRN" {{ old('document_type') == 'BRN' ? 'selected' : '' }}>BRN (Business Registration)</option>
                        <option value="NRIC" {{ old('document_type') == 'NRIC' ? 'selected' : '' }}>NRIC (IC Number)</option>
                        <option value="PASSPORT" {{ old('document_type') == 'PASSPORT' ? 'selected' : '' }}>Passport</option>
                        <option value="ARMY" {{ old('document_type') == 'ARMY' ? 'selected' : '' }}>Army ID</option>
                    </select>
                    @error('document_type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('user.customers.index') }}" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors">
                Cancel
            </a>
